...
This page contains suggested best practices when self-hosting external Relays, that is, Relays that run on your hardware and forward events to `sentry.io`.
...
This following configuration example contains values that you can adjust to change Relay's concurrency settings and buffering behavior.
